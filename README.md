...
For a small, open demo that runs locally as one Node/SQLite process—or exports as a portable folder for any static host—use the [Showcase edition](docs/showcase.md).
